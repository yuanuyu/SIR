<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="学校建学年限" prop="schoolAge">
        <el-input
          v-model="queryParams.schoolAge"
          placeholder="请输入学校建学年限"
          clearable
          @keyup.enter.native="handleQuery"
        />
      </el-form-item>
      <el-form-item label="学校面积" prop="schoolArea">
        <el-input
          v-model="queryParams.schoolArea"
          placeholder="请输入学校面积"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="schoolList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="学校建学年限" align="center" prop="schoolAge" />
      <el-table-column label="学校面积" align="center" prop="schoolArea" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="学校建学年限" prop="schoolAge">
          <el-input v-model="form.schoolAge" placeholder="请输入学校建学年限" />
        </el-form-item>
        <el-form-item label="学校面积" prop="schoolArea">
          <el-input v-model="form.schoolArea" placeholder="请输入学校面积" />
        </el-form-item>
      </el-form>
...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除school编号为"' + ids + '"的数据项？').then(function() {
